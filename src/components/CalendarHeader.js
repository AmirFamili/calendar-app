...
export const CalendarHeader = () => {
  ...
  return (
    <header className="p-4 pl-6 flex item-center ">
        ...
        <span onClick={handlePrevMonth} className="material-icons-outlined cursor-pointer bg-slate-100 rounded-tl-lg  rounded-bl-lg text-gray-800 h-14 border-r-white flex justify-center items-center">
          chevron_left
        </span>
